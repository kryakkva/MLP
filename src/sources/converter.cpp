...
namespace s21 {
    ...
    std::vector<double> Converter::convertDrawImg() {
        ...
        QImage drawImg = _image->copy(findCropArea()).scaled(28, 28, Qt::KeepAspectRatio, Qt::SmoothTransformation). \
        ...
        if (drawImg.width() > drawImg.height() * 3)
            ...
            drawImg = drawImg.scaled(28, 28, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
